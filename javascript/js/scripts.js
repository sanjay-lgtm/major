!(function (n) {
  ...
  n(window).on("load", function () {
    ...
    n(window).on("scroll load", function () {
      20 < n(".navbar").offset().top
        ? n(".fixed-top").addClass("top-nav-collapse")
        : n(".fixed-top").removeClass("top-nav-collapse");
    }),
    n(function () {
    ...
    n(".navbar-nav li a").on("click", function (t) {
      n(this).parent().hasClass("dropdown") ||
  ...
  n(window).scroll(function () {
    if (n("#counter").length) {
      ...
      0 == e &&
        n(window).scrollTop() > t &&
        (n(".counter-value").each(function () {
          var t = n(this),
            o = t.attr("data-count");
          n({ countNum: t.text() }).animate(
            { countNum: o },
            {
              duration: 2e3,
              easing: "swing",
    ...
    n("input, textarea").keyup(function () {
      "" != n(this).val()
        ? n(this).addClass("notEmpty")
        : n(this).removeClass("notEmpty");
    }),
    n("body").prepend(
      '<a href="#header" class="back-to-top page-scroll">Back to Top</a>'
    );
  n(window).scroll(function () {
    700 < n(window).scrollTop()
      ? n("a.back-to-top").fadeIn("500")
      : n("a.back-to-top").fadeOut("500");
  }),
